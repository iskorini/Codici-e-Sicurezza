...
def count_character(text):
    ...
    for character in list(map(chr, range(97, 123))):
        ...
        if char_n is not 0:
            occurences[character] = char_n
    return occurences


if __name__ == '__main__':
    distribution = count_character("")
